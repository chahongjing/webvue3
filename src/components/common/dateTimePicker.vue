<template>
  <div class="input-group date" :class='{"disabled":option?.disabled}'>
    <input class="form-control border-right-0" size="16" type="text" readonly v-model='dataText' :disabled="option?.disabled"/>
